...
**Windows (desktop app):**
Download the installer from [opencode.ai/download](https://opencode.ai/download) and run it. This is the easiest way to get started on Windows.
...
**OpenCode:**
- **Windows**: Settings > Apps > search for "OpenCode" > Uninstall
- **Mac (Homebrew):** `brew uninstall --cask opencode-desktop`
